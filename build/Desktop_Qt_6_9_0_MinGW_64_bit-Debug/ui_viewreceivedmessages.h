...
public:
    ...
    void setupUi(QDialog *viewReceivedMessages)
    {
        ...
        widget->setGeometry(QRect(-11, -21, 971, 871));
...
"}"));
        ...
        label->setGeometry(QRect(290, -30, 321, 141));
...
"}"));
        ...
        comboBox->setGeometry(QRect(410, 120, 86, 26));
        scrollArea = new QScrollArea(widget);
        scrollArea->setObjectName("scrollArea");
        scrollArea->setGeometry(QRect(170, 250, 621, 491));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName("scrollAreaWidgetContents");
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 619, 489));
        scrollArea->setWidget(scrollAreaWidgetContents);
        back = new QPushButton(widget);
        back->setObjectName("back");
        back->setGeometry(QRect(260, 760, 432, 156));
...
"}"));
        ...
        view->setGeometry(QRect(380, 170, 151, 101));
...
"}"));
    ...
    void retranslateUi(QDialog *viewReceivedMessages)
    {
        ...
        view->setText(QCoreApplication::translate("viewReceivedMessages", "View", nullptr));
    } // retranslateUi
