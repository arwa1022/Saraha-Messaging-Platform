...
"}"));
        ...
        comboBox->setGeometry(QRect(350, 120, 76, 26));
        comboBox->setCursor(QCursor(Qt::CursorShape::ArrowCursor));
        comboBox->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        comboBox->setEditable(false);
        checkBox = new QCheckBox(widget);
        checkBox->setObjectName("checkBox");
        checkBox->setGeometry(QRect(330, 160, 141, 24));
...
""));
    ...
    void retranslateUi(QDialog *sendMessage)
    {
        ...
        checkBox->setText(QCoreApplication::translate("sendMessage", "Show My name", nullptr));
    } // retranslateUi
